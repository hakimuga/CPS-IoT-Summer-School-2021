...
{
	return (int) ((function_param_1+ function_param_2) /2);
...
{
	return avg(function_param_0+1, 3)-1;
...
{
           if(function_param_0 == 3){ return 1;}
	return 0;

}
int inUnload (int function_param_0)
{
	if(function_param_0 == 2){ return 1;}
	return 0;

}
int inDocking (int function_param_0)
{
	if(function_param_0 == 1){ return 1;}
	return 0;
...
{
           if(function_param_0 >= 4){ return 1;}
	return 0;
...
{
	if(function_param_0 == 5){ return 1;}
	return 0;
